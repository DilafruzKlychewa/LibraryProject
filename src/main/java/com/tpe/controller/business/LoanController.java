...
public class LoanController {
    ...
    @GetMapping("/findLoanByPage") // http://localhost:8081/loans?page=1&size=10&sort=loanDate&type=desc
    ...
    @PreAuthorize("hasAnyAuthority( 'MEMBER')")
    @GetMapping("/getLoanById/{loanId}")  // http://localhost:8081/loans/getLoanById/1
    ...
    @GetMapping("/getLoansByUserId/{userId}")  // http://localhost:8081/loans/user/5?page=1&size=10&sort=loanDate&type=desc
    ...
    //4.GET
    @PreAuthorize("hasAnyAuthority('EMPLOYEE','ADMIN')")
    @GetMapping("/getLoansByBookId/{bookId}") // http://localhost:8081/loans/book/5?page=1&size=10&sort=loanDate&type=desc
    ...
    //5.GET ===>>
    @PreAuthorize("hasAnyAuthority('EMPLOYEE','ADMIN')")
    @GetMapping("/getLoanDetails/{loanId}") // http://localhost:8081/loans/auth/5
    ...
    //POST
    @PreAuthorize("hasAnyAuthority('EMPLOYEE','ADMIN')")
    @PostMapping("/createLoan")  // http://localhost:8081/loans
    ...
    //PUT ==>>>
    @PreAuthorize("hasAnyAuthority('EMPLOYEE','ADMIN')")
    @PutMapping("/updateLoanById/{id}") // http://localhost:8081/loans/5
