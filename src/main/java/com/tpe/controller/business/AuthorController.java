...
public class AuthorController {
    ...
    @PostMapping("/publisher") // http://localhost:8081/authors/publisher + POST + JSON
    ...
    @GetMapping //http://localhost:8081/authors?page=1&size=10&sort=name&type=asc
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('ANONYMOUS')") // http://localhost:8081/authors/1  + GET
    ...
    // Not:authorUpdate ***********************************************************************
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    @PutMapping("update/{id}") // http://localhost:8081/authors/update/4
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    @DeleteMapping("/delete/{id}") // http://localhost:8081/authors/delete/4  + JSON
