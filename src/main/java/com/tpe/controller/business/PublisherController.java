...
public class PublisherController {
    ...
    @PostMapping// http://localhost:8081/publishers
    ...
    @GetMapping("/{id}")  //http://loclahost:8081/publishers/4
    ...
    @GetMapping // http://localhost:8081/publishers?page=size10&sort=name&type=asc
