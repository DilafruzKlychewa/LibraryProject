...
public class CategoryController {
    ...
    @GetMapping // http://localhost:8081/categories + GET
    ...
    @GetMapping("/{id}") // http://localhost:8081/categories/1 + GET
    ...
    @PostMapping
    @PreAuthorize("hasAnyAuthority('ADMIN')") // http://localhost:8081/categories + POST
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('ADMIN')") // http://localhost:8081/categories/1 + PUT
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('ADMIN')") // http://localhost:8081/categories/1 + DELETE
